...
func NewReplayFileQueryService(fileMetadataReader common.Searchable[replay_entity.ReplayFile]) replay_in.ReplayFileReader {
	...
	queryableFields := map[string]bool{
		...
		"InternalURI":   common.DENY,        // SECURITY: Internal storage path
	...
	readableFields := map[string]bool{
		...
		"NetworkID":     true,
		"Size":          true,
		"InternalURI":   common.DENY,        // SECURITY: Never expose storage paths
		"Status":        true,
	...
	service := &common.BaseQueryService[replay_entity.ReplayFile]{
	...
	common.GetQueryServiceRegistry().Register("replays", service)
