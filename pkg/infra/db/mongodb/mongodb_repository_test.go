...
func Test_Mongo_QueryBuilder(t *testing.T) {
	...
	s := shared.NewSearchByID(ctx, uuid.New(), shared.ClientApplicationAudienceIDKey)
...
func TestMongoDBRepository_Query(t *testing.T) {
	...
	sampleData := []replay_entity.ReplayFile{
		{
			...
			ResourceOwner: shared.ResourceOwner{TenantID: tenantID, ClientID: clientID, GroupID: groupID, UserID: userID},
		...
		},
		{
			...
			GameID:        replay_common.CS2_GAME_ID,
			NetworkID:     replay_common.FaceItNetworkIDKey,
			...
			ResourceOwner: shared.ResourceOwner{TenantID: tenantID, GroupID: groupID, ClientID: clientID, UserID: userID},
	...
	tests := []struct {
	...
	}{
		{
			...
			search: shared.NewSearchByValues(
			...
			mockData:        sampleData,
			contextValues:   map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID, shared.ClientIDKey: clientID, shared.UserIDKey: userID},
		},
		{
			name: "Valid Query - Header Wildcard (User Level)",
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableValue{{Field: "Header.Filestamp", Values: []interface{}{"HLTV-1.0.0"}}},
				shared.SearchResultOptions{Limit: 10},
				shared.UserAudienceIDKey,
			),
		...
		},
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableValue{{Field: "Header.Filestamp", Values: []interface{}{"HLTV-1.0.0"}}},
				shared.SearchResultOptions{Limit: 10, PickFields: []string{"Header", "GameID"}},
				shared.ClientApplicationAudienceIDKey,
			),
			expectedResults: sampleData[0:1],
			mockData:        sampleData,
			contextValues:   map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID, shared.ClientIDKey: clientID},
		},
		{
			name: "Valid Query - Date Range",
			search: shared.NewSearchByRange(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableDateRange{
					{Field: "CreatedAt", Min: &sampleData[2].CreatedAt, Max: &sampleData[2].UpdatedAt},
				},
				shared.SearchResultOptions{
					Skip:       0,
					Limit:      10,
					PickFields: []string{},
					OmitFields: []string{},
		...
		// 3. Multiple Values - Filtering by NetworkID
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableValue{{Field: "NetworkID", Values: []interface{}{replay_common.SteamNetworkIDKey, replay_common.FaceItNetworkIDKey}, Operator: shared.InOperator}},
				shared.SearchResultOptions{Limit: 10},
				shared.UserAudienceIDKey,
			),
		...
		// 5. String Field - Filtering by Error (Contains) - NOT TESTED due to no sampleData containing Error value
		{
			...
			search: shared.NewSearchByValues(
				...
				[]shared.SearchableValue{
					{Field: "Error", Values: []interface{}{"connection"}, Operator: shared.ContainsOperator},
				},
				shared.SearchResultOptions{Limit: 10},
				shared.UserAudienceIDKey,
			),
		...
		// 7. Boolean Field Query - Filtering by Status
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableValue{{Field: "Status", Values: []interface{}{true}}},
				shared.SearchResultOptions{Limit: 10},
				shared.ClientApplicationAudienceIDKey,
			),
			expectedResults: sampleData[0:0],
...

		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, groupID, userID),
				[]shared.SearchableValue{{Field: "GameID", Values: []interface{}{}}},
				shared.SearchResultOptions{Limit: 10},
				shared.UserAudienceIDKey,
			),
			expectedResults: sampleData[0:0],
		...
		},
		{
			...
			search: shared.NewSearchByValues(
				...
				[]shared.SearchableValue{
					{Field: "Size", Values: []interface{}{10}, Operator: shared.GreaterThanOperator},
				},
				shared.SearchResultOptions{Limit: 10},
				shared.ClientApplicationAudienceIDKey,
			),
		...
		},
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, uuid.Nil, uuid.Nil),
				[]shared.SearchableValue{
					{Field: "Size", Values: []interface{}{10000}, Operator: shared.LessThanOperator},
				},
				shared.SearchResultOptions{Limit: 10},
				shared.ClientApplicationAudienceIDKey,
			),
		...
		},
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, uuid.Nil, uuid.Nil),
				[]shared.SearchableValue{
					{Field: "Size", Values: []interface{}{1}, Operator: shared.EqualsOperator},
				},
				shared.SearchResultOptions{Limit: 10},
				shared.ClientApplicationAudienceIDKey,
			),
		...
		// 5. String Field - Filtering (All variations)
		{
			...
			search: shared.NewSearchByValues(
				setContextWithValues(context.Background(), tenantID, clientID, uuid.Nil, uuid.Nil),
				[]shared.SearchableValue{
					{Field: "InternalURI", Values: []interface{}{"/replays/fcad61ef-67fe-4405-9a4e-1b51774bb46a"}, Operator: shared.ContainsOperator},
				},
				shared.SearchResultOptions{Limit: 10},
				shared.ClientApplicationAudienceIDKey,
			),
		...
		// 				{Field: "NetworkID", Values: []interface{}{replay_common.FaceItNetworkIDKey}},
		// 			},
		// 		},
		// 		shared.SearchResultOptions{Limit: 10},
		// 		shared.ClientApplicationAudienceIDKey,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx := setContextWithValues(context.Background(), tt.contextValues[shared.TenantIDKey], tt.contextValues[shared.ClientIDKey], tt.contextValues[shared.GroupIDKey], tt.contextValues[shared.UserIDKey])
...
func TestGetBSONFieldNameFromSearchableValue(t *testing.T) {
	...
	testCases := []struct {
		name            string
		searchableValue shared.SearchableValue
		expectedName    string
		expectedError   error
	}{
		{
			name:            "Valid Field",
			searchableValue: shared.SearchableValue{Field: "GameID", Values: []interface{}{replay_common.CS2_GAME_ID}},
			expectedName:    "game_id",
			expectedError:   nil,
		},
		{
			name:            "Valid Field with Header",
			searchableValue: shared.SearchableValue{Field: "Header.Filestamp", Values: []interface{}{"HLTV-1.0.0"}},
		...
		},
		{
			...
			searchableValue: shared.SearchableValue{Field: "NetworkID", Values: []interface{}{"value1", "value2"}},
			expectedName:    "network_id",
			expectedError:   nil,
		},
		{
			name:            "Numeric Value",
			searchableValue: shared.SearchableValue{Field: "Size", Values: []interface{}{12345}},
			expectedName:    "size",
			expectedError:   nil,
		},
		{
			name:            "Boolean Value",
			searchableValue: shared.SearchableValue{Field: "Status", Values: []interface{}{true}},
			expectedName:    "status",
			expectedError:   nil,
		},
		{
			name:            "Nonexistent Field",
			searchableValue: shared.SearchableValue{Field: "NonexistentField", Values: []interface{}{"value"}},
			expectedName:    "",
		...
		},
		{
			...
			searchableValue: shared.SearchableValue{Field: "CreatedAt", Values: []interface{}{time.Now()}},
			expectedName:    "created_at",
			expectedError:   nil,
		},
		{
			name:            "Wildcard Query",
			searchableValue: shared.SearchableValue{Field: "InternalURI.*", Values: []interface{}{"value"}},
			expectedName:    "uri",
			expectedError:   nil,
		},
		{
			name:            "Invalid Nested Field",
			searchableValue: shared.SearchableValue{Field: "Invalid.Nested", Values: []interface{}{"value"}},
			expectedName:    "",
		...
		},
		{
			...
			searchableValue: shared.SearchableValue{Field: "GameID.Invalid", Values: []interface{}{"value"}},
			expectedName:    "",
		...
		},
		{
			...
			searchableValue: shared.SearchableValue{Field: "", Values: []interface{}{"value"}},
			expectedName:    "",
			expectedError:   fmt.Errorf("empty field not allowed. cant query"),
		},
		{
			name:            "Empty Values Slice",
			searchableValue: shared.SearchableValue{Field: "GameID", Values: []interface{}{}},
			expectedName:    "game_id",
			expectedError:   nil, // Should still return the BSON field name
		},
		{
			name:            "ResourceOwner Field",
			searchableValue: shared.SearchableValue{Field: "ResourceOwner.TenantID", Values: []interface{}{uuid.New()}},
			expectedName:    "resource_owner.tenant_id", // Use the correct BSON name here
			expectedError:   nil,
		},
		{
			name:            "ResourceOwner Nested Field with Nil",
			searchableValue: shared.SearchableValue{Field: "ResourceOwner.TenantID", Values: []interface{}{nil}},
...
func TestMongoDBRepository_EnsureTenancy(t *testing.T) {
	...
	testCases := []struct {
		...
		// 	agg:           bson.M{},
		// 	search:        shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{IntendedAudience: shared.ClientApplicationAudienceIDKey, RequestSource: shared.ResourceOwner{TenantID: tenantID, ClientID: clientID}}},
		...
		// 	agg:           bson.M{},
		// 	search:        shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{IntendedAudience: shared.GroupAudienceIDKey, RequestSource: shared.ResourceOwner{TenantID: tenantID, GroupID: groupID}}},
		...
		// 	expectedError: nil,
		// 	contextValues: map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID, shared.GroupIDKey: groupID},
		// },
		// {
		// 	name:          "Success - UserAudienceIDKey",
		// 	agg:           bson.M{},
		// 	search:        shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{IntendedAudience: shared.UserAudienceIDKey, RequestSource: shared.ResourceOwner{TenantID: tenantID, UserID: userID}}},
		...
		// 	expectedError: nil,
		// 	contextValues: map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID, shared.UserIDKey: userID},
		// },
		{
			name:              "Error - Empty TenantID in Search",
			agg:               bson.M{},
			search:            shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{RequestSource: shared.ResourceOwner{}}},
			expectedAgg:       bson.M{},
		...
		},
		{
			...
			agg:               bson.M{},
			search:            shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{IntendedAudience: shared.ClientApplicationAudienceIDKey, RequestSource: shared.ResourceOwner{TenantID: tenantID}}},
			expectedAgg:       bson.M{},
			expectedErrorPart: "TENANCY.ApplicationLevel: valid client_id is required in queryCtx",
			contextValues:     map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID},
		},
		{
			name:              "Error - No Audience Provided",
			agg:               bson.M{},
			search:            shared.Search{VisibilityOptions: shared.SearchVisibilityOptions{RequestSource: shared.ResourceOwner{TenantID: tenantID, ClientID: clientID}}},
			expectedAgg:       bson.M{},
		...
		// 			RequestSource:    shared.ResourceOwner{TenantID: tenantID, UserID: userID, GroupID: groupID},
		// 		},
		// 	},
		...
		// 	expectedError: nil,
		// 	contextValues: map[interface{}]uuid.UUID{shared.TenantIDKey: tenantID, shared.UserIDKey: userID, shared.GroupIDKey: groupID},
		// },
		{
			...
			search: shared.Search{
				VisibilityOptions: shared.SearchVisibilityOptions{
					IntendedAudience: shared.UserAudienceIDKey,
					RequestSource:    shared.ResourceOwner{TenantID: tenantID, GroupID: groupID},
				},
			},
			expectedAgg:       bson.M{},
		...
		},
		{
			...
			search: shared.Search{
				VisibilityOptions: shared.SearchVisibilityOptions{
					IntendedAudience: shared.GroupAudienceIDKey,
					RequestSource:    shared.ResourceOwner{TenantID: tenantID, UserID: userID},
				},
			},
			expectedAgg:       bson.M{},
		...
		},
		{
			...
			search: shared.Search{
				VisibilityOptions: shared.SearchVisibilityOptions{
					IntendedAudience: shared.UserAudienceIDKey,
					RequestSource:    shared.ResourceOwner{TenantID: uuid.New(), UserID: userID},
				},
			},
			expectedAgg:       bson.M{},
			expectedErrorPart: "TENANCY.RequestSource: `tenant_id` in queryCtx does not match `tenant_id` in `shared.Search`",
			contextValues:     map[interface{}]uuid.UUID{shared.TenantIDKey: uuid.New(), shared.UserIDKey: userID},
		},
		{
			...
			search: shared.Search{
				VisibilityOptions: shared.SearchVisibilityOptions{
					IntendedAudience: shared.UserAudienceIDKey,
					RequestSource:    shared.ResourceOwner{TenantID: uuid.Nil, UserID: userID},
				},
			},
			expectedAgg:       bson.M{},
			expectedErrorPart: "TENANCY.RequestSource: valid tenant_id is required in queryCtx",
			contextValues:     map[interface{}]uuid.UUID{shared.TenantIDKey: uuid.Nil, shared.UserIDKey: userID},
		},
	}
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			// set context
			ctx := setContextWithValues(context.Background(), tc.contextValues[shared.TenantIDKey], tc.contextValues[shared.ClientIDKey], tc.contextValues[shared.GroupIDKey], tc.contextValues[shared.UserIDKey])
...
func TestMongoDBRepository_AddProjection(t *testing.T) {
	tests := []struct {
		...
		// 			{
		// 				From:       shared.ResourceType("foreign"),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			repo := &db.MongoDBRepository[shared.Entity]{
