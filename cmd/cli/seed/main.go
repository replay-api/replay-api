...
// Professional esports team seed data - Real teams and organizations
var seedSquads = []struct {
	...
	// CS2 Teams
	{
		...
		Description: "Born to Win. Ukrainian esports powerhouse and one of the most decorated CS organizations in history. Multiple Major champions with legendary players.",
		LogoURI:     "https://img-cdn.hltv.org/teamlogo/kixzGZIb9IYAAv-1vGrGev.svg",
		SlugURI:     "natus-vincere",
		Region:      "CIS",
		Members: []seedMember{
			{Nickname: "s1mple", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=11", MMR: 2850},
			{Nickname: "b1t", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=12", MMR: 2780},
			{Nickname: "jL", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=13", MMR: 2720},
			{Nickname: "Aleksib", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=14", MMR: 2680},
			{Nickname: "iM", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=15", MMR: 2650},
		},
	},
	{
		Name:        "G2 Esports",
		Symbol:      "G2",
		GameID:      common.CS2_GAME_ID,
		Description: "European esports giants. Known for their entertainment value and competitive excellence across multiple titles. PGL Major Copenhagen 2024 Champions.",
		LogoURI:     "https://img-cdn.hltv.org/teamlogo/zFLwAELOD15BjJSDMMNBWQ.png",
		SlugURI:     "g2-esports",
		Region:      "EU",
		Members: []seedMember{
			{Nickname: "NiKo", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=21", MMR: 2820},
			{Nickname: "m0NESY", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=22", MMR: 2800},
			{Nickname: "huNter-", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=23", MMR: 2750},
			{Nickname: "nexa", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=24", MMR: 2700},
			{Nickname: "Snax", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=25", MMR: 2680},
		},
	},
	{
		Name:        "FaZe Clan",
		...
		LogoURI:     "https://img-cdn.hltv.org/teamlogo/SMhzsxzbguPMpLgTCuXM8D.svg",
		SlugURI:     "faze-clan",
		Region:      "Global",
		Members: []seedMember{
			{Nickname: "ropz", Role: "Lurker", Avatar: "https://i.pravatar.cc/150?img=31", MMR: 2790},
			{Nickname: "broky", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=32", MMR: 2760},
			{Nickname: "rain", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=33", MMR: 2720},
			{Nickname: "karrigan", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=34", MMR: 2650},
			{Nickname: "frozen", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=35", MMR: 2730},
		},
	},
	{
		Name:        "Team Vitality",
		Symbol:      "VIT",
		GameID:      common.CS2_GAME_ID,
		Description: "French esports organization with world-class CS roster. BLAST Premier World Final champions and consistent top-tier performers.",
		LogoURI:     "https://img-cdn.hltv.org/teamlogo/GGK5E4PJyP86PvsXCOsSAI.svg",
		SlugURI:     "team-vitality",
		Region:      "EU",
		Members: []seedMember{
			{Nickname: "ZywOo", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=41", MMR: 2870},
			{Nickname: "apEX", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=42", MMR: 2680},
			{Nickname: "Spinx", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=43", MMR: 2740},
			{Nickname: "flameZ", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=44", MMR: 2760},
			{Nickname: "mezii", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=45", MMR: 2700},
		},
	},
	{
		Name:        "Team Liquid",
		...
		LogoURI:     "https://img-cdn.hltv.org/teamlogo/JMeLLbWKCIEJrmfPaqOz4O.svg",
		SlugURI:     "team-liquid",
		Region:      "NA",
		Members: []seedMember{
			{Nickname: "NAF", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=51", MMR: 2720},
			{Nickname: "YEKINDAR", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=52", MMR: 2750},
			{Nickname: "jks", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=53", MMR: 2680},
			{Nickname: "cadiaN", Role: "AWPer/IGL", Avatar: "https://i.pravatar.cc/150?img=54", MMR: 2700},
			{Nickname: "Twistzz", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=55", MMR: 2740},
		},
	},
	// Valorant Teams
	{
		...
		Description: "Iconic North American organization. VCT Masters champions and home to legendary Valorant players. Known for creating superstars.",
		LogoURI:     "https://owcdn.net/img/628e7d0f1db84.png",
		SlugURI:     "sentinels",
		Region:      "Americas",
		Members: []seedMember{
			{Nickname: "TenZ", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=61", MMR: 2800},
			{Nickname: "zekken", Role: "Flex", Avatar: "https://i.pravatar.cc/150?img=62", MMR: 2750},
			{Nickname: "Sacy", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=63", MMR: 2720},
			{Nickname: "johnqt", Role: "IGL/Controller", Avatar: "https://i.pravatar.cc/150?img=64", MMR: 2700},
			{Nickname: "pANcada", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=65", MMR: 2680},
		},
	},
	{
		Name:        "Paper Rex",
		Symbol:      "PRX",
		GameID:      common.VLRNT_GAME_ID,
		Description: "Singapore-based APAC powerhouse. Famous for their aggressive W-key playstyle that revolutionized Valorant. VCT Masters champions.",
		LogoURI:     "https://owcdn.net/img/62875027bd498.png",
		SlugURI:     "paper-rex",
		Region:      "APAC",
		Members: []seedMember{
			{Nickname: "f0rsakeN", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=1", MMR: 2780},
			{Nickname: "Jinggg", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=2", MMR: 2760},
			{Nickname: "d4v41", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=3", MMR: 2720},
			{Nickname: "Monyet", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=4", MMR: 2680},
			{Nickname: "mindfreak", Role: "Sentinel/IGL", Avatar: "https://i.pravatar.cc/150?img=5", MMR: 2700},
		},
	},
	{
		Name:        "Fnatic",
		Symbol:      "FNC",
		GameID:      common.VLRNT_GAME_ID,
		Description: "Legendary EMEA organization with a rich esports history. VCT LOCK//IN champions and consistent top performers in international competition.",
		LogoURI:     "https://owcdn.net/img/62875073c65db.png",
		SlugURI:     "fnatic",
		Region:      "EMEA",
		Members: []seedMember{
			{Nickname: "Alfajer", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=6", MMR: 2820},
			{Nickname: "Derke", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=7", MMR: 2800},
			{Nickname: "Chronicle", Role: "Sentinel", Avatar: "https://i.pravatar.cc/150?img=8", MMR: 2750},
			{Nickname: "Leo", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=9", MMR: 2720},
			{Nickname: "Boaster", Role: "IGL/Controller", Avatar: "https://i.pravatar.cc/150?img=10", MMR: 2680},
		},
	},
	{
		Name:        "DRX",
		Symbol:      "DRX",
		GameID:      common.VLRNT_GAME_ID,
		Description: "Korean esports dynasty. Valorant Champions 2022 winners and perennial favorites. Known for precision gameplay and clutch performances.",
		LogoURI:     "https://owcdn.net/img/62f580a8e2c29.png",
		SlugURI:     "drx",
		Region:      "KR",
		Members: []seedMember{
			{Nickname: "BuZz", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=16", MMR: 2780},
			{Nickname: "MaKo", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=17", MMR: 2750},
			{Nickname: "Rb", Role: "Flex", Avatar: "https://i.pravatar.cc/150?img=18", MMR: 2720},
			{Nickname: "stax", Role: "IGL/Initiator", Avatar: "https://i.pravatar.cc/150?img=19", MMR: 2700},
			{Nickname: "Foxy9", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=20", MMR: 2760},
		},
	},
	{
		Name:        "LOUD",
		Symbol:      "LOUD",
		GameID:      common.VLRNT_GAME_ID,
		Description: "Brazilian powerhouse and Valorant Champions 2022 runner-up. Massive fanbase and known for their passionate gameplay and team synergy.",
		LogoURI:     "https://owcdn.net/img/628750b5dde54.png",
		SlugURI:     "loud",
		Region:      "Americas",
		Members: []seedMember{
			{Nickname: "aspas", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=26", MMR: 2850},
			{Nickname: "Less", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=27", MMR: 2780},
			{Nickname: "tuyz", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=28", MMR: 2720},
			{Nickname: "cauanzin", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=29", MMR: 2740},
			{Nickname: "qck", Role: "Sentinel", Avatar: "https://i.pravatar.cc/150?img=30", MMR: 2700},
		},
	},
}
...
var seedPlayers = []struct {
	...
	},
	{
		...
		Description: "Former CS Major champion turned Valorant pro. Exceptional leadership and game sense. Intel Grand Slam winner with Team Liquid.",
		MMR:         2650,
		Region:      "NA",
	},
	{
	...
	},
	{
		...
		Description: "NA Operator specialist known for aggressive peeks and clutch rounds. Former TSM star player with incredible mechanical skill.",
		MMR:         2550,
		Region:      "NA",
	},
	{
		...
		Description: "Legendary Astralis IGL and 4x Major champion. Mastermind behind the most dominant CS era. Seeking new roster opportunities.",
		MMR:         2680,
		Region:      "EU",
	},
	{
		...
		Description: "Brazilian prodigy and FURIA cornerstone. Known for explosive entry fragging and mechanical perfection. Top 10 HLTV player.",
		MMR:         2720,
		Region:      "SA",
	},
	{
		...
		Description: "The Headshot Machine. CS legend turned Valorant star. Known for inhuman aim and one-tap kills. Team Liquid Valorant foundation.",
		MMR:         2620,
		Region:      "EMEA",
	},
	{
		...
		Description: "NAVI legend and Major champion. One of the best riflers in CS history. Explosive gameplay and clutch factor.",
		MMR:         2780,
		Region:      "CIS",
	},
	{
		...
		Roles:       []string{"Chamber", "Operator"},
		Description: "El Diablo. VCT Masters champion with OpTic Gaming. Chamber specialist with unmatched operator precision. LFT for international team.",
		MMR:         2750,
		Region:      "NA",
	},
	{
		...
		Description: "Back-to-back HLTV #1 player. 2x Major champion and Brazilian CS icon. Versatile player with legendary clutch ability.",
		MMR:         2700,
		Region:      "SA",
	},
	{
		...
		Description: "Turkish Valorant superstar. VCT Champions 2021 winner with Acend. Known for aggressive Jett plays and insane mechanical skill.",
		MMR:         2680,
		Region:      "EMEA",
	},
	{
