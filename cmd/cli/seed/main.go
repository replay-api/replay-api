...
var seedSquads = []struct {
	...
	// CS2 Teams
	{
		...
		Region:      "CIS",
		Members: []seedMember{
			{Nickname: "vortex", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=11", MMR: 2850},
			{Nickname: "krait", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=12", MMR: 2780},
			{Nickname: "shadowX", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=13", MMR: 2720},
			{Nickname: "mirko", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=14", MMR: 2680},
			{Nickname: "ashK", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=15", MMR: 2650},
		},
	},
	{
		Name:        "N3 Gaming",
		...
		Region:      "EU",
		Members: []seedMember{
			{Nickname: "rayzer", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=21", MMR: 2820},
			{Nickname: "phxnt0m", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=22", MMR: 2800},
			{Nickname: "buzzcut", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=23", MMR: 2750},
			{Nickname: "cortex", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=24", MMR: 2700},
			{Nickname: "driftZ", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=25", MMR: 2680},
		},
	},
	{
		...
		Region:      "Global",
		Members: []seedMember{
			{Nickname: "hexen", Role: "Lurker", Avatar: "https://i.pravatar.cc/150?img=31", MMR: 2790},
			{Nickname: "prizmX", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=32", MMR: 2760},
			{Nickname: "voltz", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=33", MMR: 2720},
			{Nickname: "tactyk", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=34", MMR: 2650},
			{Nickname: "glacierX", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=35", MMR: 2730},
		},
	},
	{
		Name:        "Team Velocity",
		...
		Region:      "EU",
		Members: []seedMember{
			{Nickname: "scopeZ", Role: "AWPer", Avatar: "https://i.pravatar.cc/150?img=41", MMR: 2870},
			{Nickname: "merkury", Role: "IGL", Avatar: "https://i.pravatar.cc/150?img=42", MMR: 2680},
			{Nickname: "thunderV", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=43", MMR: 2740},
			{Nickname: "pyreX", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=44", MMR: 2760},
			{Nickname: "nullify", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=45", MMR: 2700},
		},
	},
	{
		Name:        "Team Fluid",
		...
		Region:      "NA",
		Members: []seedMember{
			{Nickname: "razorK", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=51", MMR: 2720},
			{Nickname: "clutchM", Role: "Entry Fragger", Avatar: "https://i.pravatar.cc/150?img=52", MMR: 2750},
			{Nickname: "vectorN", Role: "Support", Avatar: "https://i.pravatar.cc/150?img=53", MMR: 2680},
			{Nickname: "warden77", Role: "AWPer/IGL", Avatar: "https://i.pravatar.cc/150?img=54", MMR: 2700},
			{Nickname: "flashG", Role: "Rifler", Avatar: "https://i.pravatar.cc/150?img=55", MMR: 2740},
		},
	},
	// Valorant Teams
	{
		...
		Region:      "Americas",
		Members: []seedMember{
			{Nickname: "zenithX", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=61", MMR: 2800},
			{Nickname: "axiomK", Role: "Flex", Avatar: "https://i.pravatar.cc/150?img=62", MMR: 2750},
			{Nickname: "shimmer", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=63", MMR: 2720},
			{Nickname: "terraV", Role: "IGL/Controller", Avatar: "https://i.pravatar.cc/150?img=64", MMR: 2700},
			{Nickname: "cloudR", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=65", MMR: 2680},
		},
	},
	{
		...
		Region:      "APAC",
		Members: []seedMember{
			{Nickname: "hunterX", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=1", MMR: 2780},
			{Nickname: "blitzN", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=2", MMR: 2760},
			{Nickname: "specterV", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=3", MMR: 2720},
			{Nickname: "novaK", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=4", MMR: 2680},
			{Nickname: "vexR", Role: "Sentinel/IGL", Avatar: "https://i.pravatar.cc/150?img=5", MMR: 2700},
		},
	},
	{
		Name:        "Fanatic Gaming",
		...
		Region:      "EMEA",
		Members: []seedMember{
			{Nickname: "strikeX", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=6", MMR: 2820},
			{Nickname: "nightV", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=7", MMR: 2800},
			{Nickname: "shieldK", Role: "Sentinel", Avatar: "https://i.pravatar.cc/150?img=8", MMR: 2750},
			{Nickname: "primeZ", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=9", MMR: 2720},
			{Nickname: "smokeR", Role: "IGL/Controller", Avatar: "https://i.pravatar.cc/150?img=10", MMR: 2680},
		},
	},
	{
		Name:        "DRZ Gaming",
		...
		Region:      "KR",
		Members: []seedMember{
			{Nickname: "phantomK", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=16", MMR: 2780},
			{Nickname: "waveX", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=17", MMR: 2750},
			{Nickname: "echoN", Role: "Flex", Avatar: "https://i.pravatar.cc/150?img=18", MMR: 2720},
			{Nickname: "deltaV", Role: "IGL/Initiator", Avatar: "https://i.pravatar.cc/150?img=19", MMR: 2700},
			{Nickname: "vaporR", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=20", MMR: 2760},
		},
	},
	{
		Name:        "ROAR Esports",
		...
		Region:      "Americas",
		Members: []seedMember{
			{Nickname: "blazeN", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=26", MMR: 2850},
			{Nickname: "quickX", Role: "Initiator", Avatar: "https://i.pravatar.cc/150?img=27", MMR: 2780},
			{Nickname: "haloV", Role: "Controller", Avatar: "https://i.pravatar.cc/150?img=28", MMR: 2720},
			{Nickname: "rushK", Role: "Duelist", Avatar: "https://i.pravatar.cc/150?img=29", MMR: 2740},
			{Nickname: "guardR", Role: "Sentinel", Avatar: "https://i.pravatar.cc/150?img=30", MMR: 2700},
		},
	},
}
...
var seedPlayers = []struct {
...
}{
	{
		...
		Description: "Champion and one of the greatest players of all time. Multiple title winner seeking new challenges. Precision AWPing and clutch performances.",
		MMR:         2750,
		Region:      "EU",
	},
	{
		...
		Description: "Former champion turned tactical shooter pro. Exceptional leadership and game sense. Grand Slam winner seeking new opportunities.",
		MMR:         2650,
		Region:      "NA",
	},
	{
		...
		Roles:       []string{"AWPer"},
		Description: "The Magic Stick. One of the most aggressive AWPers in history. Former world #1 player with legendary highlight reels.",
		MMR:         2600,
		Region:      "EU",
	},
	{
	...
	},
	{
		...
		Description: "Legendary IGL and multiple champion. Mastermind behind dominant eras. Seeking new roster opportunities.",
		MMR:         2680,
		Region:      "EU",
	},
	{
	...
	},
	{
		...
		Description: "CIS legend and champion. One of the best riflers in history. Explosive gameplay and clutch factor.",
		MMR:         2780,
		Region:      "CIS",
	},
	{
		...
		Description: "International champion. Sentinel specialist with unmatched operator precision. LFT for international team.",
		MMR:         2750,
		Region:      "NA",
	},
	{
		...
		Description: "Back-to-back world #1 player. Multiple champion and Brazilian icon. Versatile player with legendary clutch ability.",
		MMR:         2700,
		Region:      "SA",
	},
	{
		...
		Description: "European tactical shooter superstar. Champions winner. Known for aggressive plays and insane mechanical skill.",
		MMR:         2680,
		Region:      "EMEA",
	},
	{
		...
		Description: "NA champion and smoke master. Aggressive playstyle that defined a generation. Looking for redemption arc.",
		MMR:         2580,
		Region:      "NA",
	},
}
