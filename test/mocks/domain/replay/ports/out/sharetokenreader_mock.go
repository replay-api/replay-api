...
// FindByResourceID provides a mock function
func (_m *MockShareTokenReader) FindByResourceID(ctx context.Context, resourceID uuid.UUID) ([]replay_entity.ShareToken, error) {
